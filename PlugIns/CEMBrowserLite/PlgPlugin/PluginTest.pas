...
type
  ...
  private
	...
	public
		...
		procedure Init(const MainApp: IMyMainAppInterface;ThisURL:String); overload;
		procedure Init(const MainApp: IMyMainAppInterface); overload;
...
procedure TTest.Init(const MainApp: IMyMainAppInterface;ThisURL:String);
begin
	FMainApp := MainApp;
	if frmPluginForm <> nil then
		frmPluginForm.MainApp := MainApp;
