...
begin
  ...
  begin
    ...
    // thisfolder should be validated by the sender
		...
		FrmMain1.Varcoded.EnterProc('Updating mod list');
		FrmMain1.Log('Mod folder:' + thisfolder);
		FrmMain1.Log('Deleting old data from mods');
		DeleteMods();

		FileList := TStringList.Create;

		FrmMain1.Log('Reading mod files from ' + thisfolder);
		...
		FrmMain1.Log('Importing MODS data to db');

		// add all mods
		FrmMain1.Log('Adding mods info');

		FrmMain1.Varcoded.ExitProc('Updating mod list');
